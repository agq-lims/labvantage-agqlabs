 ...
 */
public class presupuestoalta extends BaseAction {

    public static final String ESTADO_VACIO = "4";
    private String CLASSNAME = "presupuestoalta";
    ...
    public void processAction(PropertyList props) throws SapphireException {
        ...
        if (!"".equals(vOfertaId)) {
            this.error = true;
            this.output = "Ya existe un presupuesto con código: " + pCodPresupuesto;
        }
        //
        PropertyList plData = new PropertyList();
        if (!this.error) {
            estado = getEstado(props.getProperty("Estado", ESTADO_VACIO));
            plData.setProperty("u_ofertaid", pCodPresupuesto);
...
//                    }
                ...
                java.util.logging.Logger.getLogger(presupuestoalta.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        //
        if (!this.error) {
            ...
            getActionProcessor().processAction("AddSDI", "1", plData);
            String ofertaid = pCodPresupuesto; //plData.getProperty("newkeyid1");
            //
            try {
                JSONArray joa = new JSONArray(strTemp);
                String codArticulo;
                ...
                for (int k = 0; k < joa.length(); k++) {
                    ...
                    if (ox.equals(true)) {
                        ...
                        plData.setProperty("codlinea", valueJsonString(jox, "CodLinea"));
                        ...
                        if (ox.equals("null") || ox.equals("")) {
                            ...
                            if (!ox.equals("null") && !ox.equals("")) {
                                ...
                                meLogInfo(this.CLASSNAME + " plData=" + plData.toJSONString());
                                getActionProcessor().processAction("AddSDI", "1", plData);
                                String ofertaatid = plData.getProperty("newkeyid1");
                                //
                                ...
                                for (int jj = 0; jj < joc.length(); jj++) {
                                    ...
                                    if (!co.equals("null") && !"".equals(co)) {
                                        ...
                                        if (!"".equals(countryData)) {
                                            ...
                                            plData.setProperty("u_ofertaatid", ofertaatid);
                                            ...
                                            meLogInfo(this.CLASSNAME + " plData=" + plData.toJSONString());
                                            getActionProcessor().processAction("AddSDIDetail", "1", plData);
                                        } else {
                            ...
                            if (dsLegislacion.getRowCount() > 0) {
                                ...
                                plData.setProperty("copies", "1");
                                plData.setProperty("u_ofertaatid", ofertaatid);
                                plData.setProperty("legislacionid", dsLegislacion.getValue(0, "specid")); // specid, u_codagq, specversionid, specdesc
