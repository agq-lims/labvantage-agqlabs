 ...
 */
public class InterfaceMuestrasPagadas extends BaseAction {

    private final String CLASSNAME = "InterfaceMuestrasPagadas";
    ...
    public InterfaceMuestrasPagadas() {
    }
    ...
    public void processAction(PropertyList props) throws SapphireException {
        //
        this.meLogInfo(this.CLASSNAME + " - BEGIN");
        ...
        if ("".equalsIgnoreCase(CodMuestra)) {
            ...
            if (!"".equalsIgnoreCase(message)) {
                ...
                this.meLogInfo(this.CLASSNAME + " message=" + props.toJSONString());
                ...
                try {
                    ...
                    java.util.logging.Logger.getLogger(InterfaceMuestrasPagadas.class.getName()).log(Level.SEVERE, (String)null, ex);
                }
            }
        }
        //
        ...
        if (dsSamples.getRowCount() > 0) {
            ...
            plEditSDI.setProperty("u_pagada", "Y");
...
//        String encoding = Base64.getEncoder().encodeToString(authorization.getBytes());
        ...
        try {
            ...
            this.meLogInfo("STATUS: " + this.status);
            this.output = this.error ? "ERROR! STATUS:" + this.status  : "Message processed successfully.";
    ...
    private void addMessageLog(String jsonObject, PropertyList properties) throws ActionException {
        ...
        plAddMessageLog.setProperty("processstatus", this.error ? "ERROR" : "COMPLETE");
        plAddMessageLog.setProperty("processnotes", this.output);
        plAddMessageLog.setProperty("processlog", this.processlog);

        this.getActionProcessor().processAction(AddSDI.ID, AddSDI.VERSIONID, plAddMessageLog);
    }

    private void meLogInfo(String strInfo) {
        this.logger.info(strInfo);
        this.processlog += "\n" + strInfo;
    }
