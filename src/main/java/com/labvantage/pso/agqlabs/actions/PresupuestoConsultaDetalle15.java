...
public class PresupuestoConsultaDetalle15 extends BaseAction {


    public static final String GET = "GET";
    public static final String POST = "POST";
    public static final String COD_PRESUPUESTO = "codPresupuesto";
    ...
    public void processAction(PropertyList propertyList) throws SapphireException {
        ...
        String codPresupuesto = propertyList.getProperty(COD_PRESUPUESTO);
        logger.info("Inicia el procesamiento del presupuesto con CodPresupuesto: " + codPresupuesto);
        ...
        try {
            ...
            String urlService = config.get("URL Base") +  config.get("URL Presupuesto Detalle") + "/" + codPresupuesto;
            ...
            boolean existe = validarExistenciaPresupuesto(codPresupuesto);
    ...
    public boolean validarExistenciaPresupuesto(String codPresupuesto){
        ...
        if (resultQuery != null && resultQuery.getRowCount() > 0
                && Integer.parseInt(resultQuery.getString(1, "presupuesto")) == 0){
            existe = false;
        }
    ...
    public String getToken(){
        ...
        DataSet resultQuery = this.getQueryProcessor().getSqlDataSet(sql);
        return resultQuery.getString(1, "tokenvalue");
