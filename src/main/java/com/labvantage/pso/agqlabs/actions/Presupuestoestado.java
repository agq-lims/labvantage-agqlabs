 ...
 */
public class Presupuestoestado extends BaseAction {
    ...
    public void processAction(PropertyList props) throws SapphireException {
        ...
        String pEstado = getEstado(props.getProperty("Estado", ESTADO_VACIO));
        ...
        if (!this.error) {
            ...
            if (!"".equals(vOfertaId)) {
                ...
                plData.setProperty("fecha_ultima_aceptacion", pFechaUltimaAceptacion.replace("T", " "));
